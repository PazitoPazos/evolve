...
function StartStop() {
  ...
  return (
    <div className="bt-0 relative mb-4 box-border flex h-12 w-full border-collapse items-center justify-center border-4 border-solid border-secondary-light text-[#b3b3b3]">
      <button
        className={
          serverStatus === 'loading'
            ? 'hidden'
            : 'flex cursor-pointer items-center gap-1 text-lg hover:text-[#888]'
        }
        onClick={
